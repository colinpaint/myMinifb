...
//{{{
mfb_stub * mfb_stub::GetInstance(struct mfb_window *window) {
    struct stub_vector {
...
//}}}
//{{{
void mfb_stub::active_stub(struct mfb_window *window, bool isActive) {
...
//{{{
void mfb_stub::resize_stub(struct mfb_window *window, int width, int height) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    stub->m_resize(window, width, height);
}
//}}}
//{{{
bool mfb_stub::close_stub(struct mfb_window *window) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    return stub->m_close(window);
}
//}}}
//{{{
void mfb_stub::keyboard_stub(struct mfb_window *window, mfb_key key, mfb_key_mod mod, bool isPressed) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    stub->m_keyboard(window, key, mod, isPressed);
}
//}}}
//{{{
void mfb_stub::char_input_stub(struct mfb_window *window, unsigned int code) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    stub->m_char_input(window, code);
}
//}}}
//{{{
void mfb_stub::mouse_btn_stub(struct mfb_window *window, mfb_mouse_button button, mfb_key_mod mod, bool isPressed) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    stub->m_mouse_btn(window, button, mod, isPressed);
}
//}}}
//{{{
void mfb_stub::mouse_move_stub(struct mfb_window *window, int x, int y) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
    stub->m_mouse_move(window, x, y);
}
//}}}
//{{{
void mfb_stub::scroll_stub(struct mfb_window *window, mfb_key_mod mod, float deltaX, float deltaY) {
    mfb_stub    *stub = mfb_stub::GetInstance(window);
